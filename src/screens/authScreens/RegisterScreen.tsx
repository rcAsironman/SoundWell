          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              ...
              >
                  ...
                  >
                      ...
                      <Text className='text-2xl font-medium tracking-[1px] mt-8 md:text-[30px] md:mt-[105px]'>SignUp</Text>
                  ...
                  <View className='flex-1 items-center justify-end mt-40'>
                      ...
                      <View className='flex-row items-center justify-center mt-[50px]'>
                          <Text className='text-soundWell-textColor text-[14px] font-medium tracking-[1px] md:text-2xl '>Already have an account? </Text>
                          <Text className='text-soundWell-primary text-[14px] font-medium tracking-[1px] md:text-2xl '>Sign In</Text>
                      </View>
                  </View>
              </ScrollView>
          </TouchableWithoutFeedback>
